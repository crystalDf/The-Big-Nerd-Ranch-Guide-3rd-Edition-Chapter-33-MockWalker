...
public class MockWalk extends HandlerThread {
    ...
    private Runnable mLocationUpdate = () -> {
        postNextLocation();

        scheduleNextUpdate();
    };

    public MockWalk(GoogleApiClient googleApiClient) {
        super("MockWalk");
    ...
    private void updateClientMockState() {
        LocationServices.FusedLocationApi
                .setMockMode(mGoogleApiClient, isEnabled());
    }
    ...
    private void postNextLocation() {
        ...
        LocationServices.FusedLocationApi
                .setMockLocation(mGoogleApiClient, nextLocation);
